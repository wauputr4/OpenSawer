<script lang="ts">
	import { Eye, EyeOff, LockKeyhole, Mail, UserRound } from '@lucide/svelte';
...
<section class="mx-auto max-w-2xl px-5 pt-8 pb-16 lg:px-8">
	...
	>
		...
		<fieldset>
			<legend class="mb-3 text-sm font-bold">Tampil di halaman publik</legend>
